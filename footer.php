				...
				<div id="main-footer">
					<div class="row">
						<div class="social">
							<h4>Want more?</h4>
							<ul>
								<li><a href="https://vimeo.com/album/3630384">Watch the Live Sent messages</a></li>
								<li><a href="#">Experience Challenge Conference</a></li>
							</ul>
						</div>
					</div>
					<div class="row">
						<a href="https://go.efca.org/ministries/reachnational/reachstudents"><img src="<?php bloginfo('template_directory'); ?>/images/reachstudents.svg" /></a>
					</div>
				</div>
				<div id="sub-footer">
					<div class="row">
						<p>Built by</p>
						<a href="https://www.efca.org/explore">
						<!-- <img src="<?php bloginfo('template_directory'); ?>/images/efca-icon.svg" /> -->
